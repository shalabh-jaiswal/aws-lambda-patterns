 ...
 */
public class PutArticle implements RequestHandler<HttpRequest, HttpResponse> {
    ...
    public HttpResponse handleRequest(HttpRequest httpRequest, Context context) {
            ...
            try {
                ...
                Map<String, AttributeValue> attributes = convert(httpRequest.getQueryStringParameters());
